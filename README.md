...
These saved mels are then used to finetune HiFiGAN, closing the gap between ground-truth mel distributions and Tacotron2-generated mels. For evaluation, the _GAN(HIFI)/inference.ipynb_ notebook demonstrates how Tacotron2 + HiFiGAN are combined to synthesize speech.
